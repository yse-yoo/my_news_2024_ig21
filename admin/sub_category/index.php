...
<body class="bg-gray-100">
    ...
    <main class="container mx-auto px-4 py-8">
        <h1 class="text-2xl font-bold mb-4">中カテゴリー</h1>
        <h1 class="text-xl font-bold mb-4">スポーツ</h1>
        <div class="mt-3 mb-3">
